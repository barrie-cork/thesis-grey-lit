#!/usr/bin/env python
"""
Sprint 6 Testing Script: Timeline and History Features (Fixed for Linux/WSL)
...
python test_sprint6_timeline_history_fixed.py
"""
...
# Setup Django environment with correct settings module
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "clean":
        ...
        try:
            ...
            print("5. Try again: python test_sprint6_timeline_history_fixed.py")
